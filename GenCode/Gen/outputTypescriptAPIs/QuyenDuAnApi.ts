...
export interface GetQuyenDuAnByDuAnIdParams extends Pagination {
   duAnId : number
}

class QuyenDuAnApi extends BaseApi {
    
    getQuyenDuAnByDuAnId(getQuyenDuAnByDuAnIdParams: GetQuyenDuAnByDuAnIdParams) {
        return new Promise<PaginatedResponse<QuyenDuAnDTO>>((resolve: any, reject: any) => {
            HTTP.get(`api/QuyenDuAn`, { params: getQuyenDuAnByDuAnIdParams })
            .then((response) => {
