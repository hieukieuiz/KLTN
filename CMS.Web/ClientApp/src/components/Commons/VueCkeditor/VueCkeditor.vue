            ...
            create() {
                if (typeof CKEDITOR === 'undefined') {
                    ...
                    if (this.config) {
                        ...
                        this.config.filebrowserBrowseUrl= '/MediaFilesManager';
                        this.config.filebrowserImageBrowseUrl= '/MediaFilesManager?type=Images';
                        this.config.filebrowserUploadUrl= '/MediaFilesManager';
                        this.config.filebrowserImageUploadUrl= '/MediaFilesManager?type=Images';
                        this.config.extraPlugins = 'codesnippet,youtube';
                        this.config.codeSnippet_theme = 'Vs';
                    ...
                    if (typeof CKFinder !== 'undefined' && typeof CKFinder !== undefined) {
                        let config = {
